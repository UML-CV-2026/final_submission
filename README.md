...
## Demo
We have a streamlit demo at `demo/` folder. There's also two images from the FIVES dataset to try out. Unfortunately the demo only works well with images that are have dimensions of a multiple of 16.
